...
--
-- Host: localhost
-- Generation Time: Aug 23, 2015 at 01:52 AM
...
(1, 'pbkdf2_sha256$20000$PmLEAXR7BVsF$8E/By7AOEVGHtyrmjlwLNSg3y2eiAXAKyIeondECpek=', NULL, 1, 'root', '', '', 'tejas.niphadkar@gmail.com', 1, 1, '2015-08-22 10:45:06');
...
CREATE TABLE IF NOT EXISTS `complaint` (
  ...
  `complaint_type` int(11) NOT NULL DEFAULT '-1',
  `compaint_desc` varchar(500) NOT NULL DEFAULT 'NONE',
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `complaint_resolved_status` tinyint(1) NOT NULL DEFAULT '0',
  `location` varchar(300) NOT NULL DEFAULT 'NONE',
  `username` varchar(30) NOT NULL,
...
(1, 'contenttypes', '0001_initial', '2015-08-22 10:44:24'),
(2, 'auth', '0001_initial', '2015-08-22 10:44:26'),
(3, 'admin', '0001_initial', '2015-08-22 10:44:26'),
(4, 'contenttypes', '0002_remove_content_type_name', '2015-08-22 10:44:26'),
(5, 'auth', '0002_alter_permission_name_max_length', '2015-08-22 10:44:27'),
(6, 'auth', '0003_alter_user_email_max_length', '2015-08-22 10:44:27'),
(7, 'auth', '0004_alter_user_username_opts', '2015-08-22 10:44:27'),
(8, 'auth', '0005_alter_user_last_login_null', '2015-08-22 10:44:27'),
(9, 'auth', '0006_require_contenttypes_0002', '2015-08-22 10:44:27'),
(10, 'sessions', '0001_initial', '2015-08-22 10:44:27');
...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  KEY `fk_imagesrefcomplaint` (`complaint_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `type_lookup` (`complaint_name`, `complaint_type`) VALUES
('roads', 1),
('electricity', 2),
('drinking_water', 3),
('portable_water', 4),
...
ALTER TABLE `action_log`
  ADD CONSTRAINT `fk_allactionsdelondelcomplaint` FOREIGN KEY (`complaint_id`) REFERENCES `complaint` (`complaint_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `images`
  ADD CONSTRAINT `fk_linksdelondelcomplaints` FOREIGN KEY (`complaint_id`) REFERENCES `complaint` (`complaint_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
